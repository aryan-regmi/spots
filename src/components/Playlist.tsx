...
import { Playlist, Track } from '@/backendApi/musicLibraryService';
...
/** A larger version of the playlist card. */
...
/** A card for a track. */
export function TrackCard(props: { track: Track }) {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={track.imgSrc || 'unknown-track.png'}
          style={{
            width: '4em',
            height: '4em',
            'border-radius': '0.5em',
